---
title: "Quantifying the evolution of cycling network performance: A XX-city panel data analysis using open data"
subtitle: "A XX-city panel data analysis using open data"
format:
  nature-pdf:
...
abstract: |
  Despite significant investments in cycling infrastructure, planning approaches often lack systematic methods to assess or simulate their potential impacts on trip performance, stress, and accessibility. Consequently, the holistic performance of the cycling network remains under-evaluated. This research addresses this gap by integrating geospatial and accessibility analysis into a replicable framework for evaluating cycling networks across various stages of development.
    ...
    Results highlight potential behavioral trade-offs between route circuity, safety, and travel time. Furthermore, ...
...
knitr::opts_chunk$set(eval = FALSE,
                      ...
                      fig.align = "center",
                      dpi = 300)
#load minimal required libraries for the paper
library(tidyverse)
```

# Main

[See examples of articles in Nature Cities - they follow a very different structure!]
...
Use a 10km projected buffer from city center, that defines the city areas for this research, for comparison purposes
...
Further developments of this research include the use a common trip-length distribution in urban environments, such as distributions described by @kou2019, when analysing bike sharing data from 7 cities in the US, with the set parameters for commuting trips (in miles).
...
Code used to generate results from this study are available at [temospena.github.com/Sydney](https://temospena.github.com/Sydney/code/pipeline). 
<!-- change the repo name later! -->
